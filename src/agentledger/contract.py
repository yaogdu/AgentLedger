...
def runtime_contract() -> dict[str, Any]:
    ...
    return {
        ...
        "policy_contract": {
            "status": "stable-runtime-core-contract",
            "request_fields": ["stage", "subject", "action", "resource", "context", "signals", "runtime_state", "policy_version"],
            "decision_fields": ["effect", "action_tier", "risk_level", "controls", "reasons", "findings", "policy_version", "subject_scope", "delegation_allowed"],
            "finding_fields": ["id", "severity", "source", "message", "evidence"],
            "control_fields": ["kind", "reason", "metadata"],
            "effects": ["allow", "deny", "require_approval"],
            "action_tiers": ["L0", "L1", "L2", "L3", "L4", "L5"],
            "control_kinds": ["audit", "approval", "sandbox", "redact", "budget", "deny"],
            "built_in_evaluators": ["role_capability", "action_boundary", "runtime_state"],
            "adapter_evaluators": ["OPA", "Cedar", "PII", "prompt_injection", "DLP", "enterprise_policy_service"],
            "gate_semantics": "gates intercept actions before execution, ask the PolicyEngine for a decision, then enforce controls locally",
        },
