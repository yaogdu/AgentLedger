...
| Tool/context protocol | MCP transport | MCP is a natural tool/context boundary for agents. Runtime should govern MCP tools without owning every tool server. | `mcp_adapters.v1.json`, `optional_adapters.v1.json` | `agentledger-mcp` |
