...
4. Python、TypeScript、Rust 的 package release family 已自动检查；当前 core release family 是 `1.3`。Python 可以有 Inspector-only patch release，例如 `1.3.4`，不代表非 Python runtime-core baseline 必须同时变化。
