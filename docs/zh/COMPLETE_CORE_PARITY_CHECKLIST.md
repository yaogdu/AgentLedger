...
4. Python、TypeScript、Rust 的 package release family 已自动检查；当前 core release family 是 `1.4`。1.4.1 是 Agent Failure Lifecycle 加 Runtime Model Evidence Boundary 的四语言 runtime-core feature release。
