...
4. Python、TypeScript、Rust 的 package release family 已自动检查；当前 core release family 是 `1.5`。`1.5.2` 是这个 family 下最新对齐的 patch；`1.5.0` 引入了 framework/Temporal adoption examples、smoke coverage 和 benchmark gate。
