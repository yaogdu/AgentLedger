...
| Runtime Model Evidence Boundary | `agentledger.model.evidence.v1`、external model-call evidence API、`model_call_requested/completed/failed`、`tool_call_proposed`、model failure category，以及 replay-safe archived model evidence semantics |
