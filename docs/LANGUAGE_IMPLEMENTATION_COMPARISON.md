...
| OMP runtime bridge | Yes | Yes | Yes | Yes | Normalized session/turn/model/tool/failure/state records mapped to AgentLedger evidence without OMP or application-specific dependencies. |
