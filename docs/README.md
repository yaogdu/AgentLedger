...
| Plan an Oh My Pi / OMP runtime adapter | `OMP_RUNTIME_ADAPTER_DESIGN.md` | `zh/OMP_RUNTIME_ADAPTER_DESIGN.md` |
...
- `OMP_RUNTIME_ADAPTER_DESIGN.md`: optional Oh My Pi / OMP runtime adapter boundary, event mapping, state-versioning guidance, privacy rules, and phased implementation plan.
